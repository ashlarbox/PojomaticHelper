...
public class MapEqualsFieldFunction_UT {

    private final MapEqualsFieldFunction function = new MapEqualsFieldFunction();
    ...
    public void functionShouldAddFieldToEqualsMapping() {
        ...
        verify(pojomaticMappings).addEqualsField(field);
    }
}
