...
public class MapToStringFieldFunction_UT {

    private final MapToStringFieldFunction function = new MapToStringFieldFunction();
    ...
    public void functionShouldAddFieldToEqualsMapping() {
        ...
        verify(pojomaticMappings).addToStringField(field);
    }
}
